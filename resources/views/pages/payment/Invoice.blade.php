                ...
                <div id="invoice-template" class="card-body">
                    ...
                    <div id="invoice-company-details" class="row">
                        ...
                        <div class="col-md-6 col-sm-12 text-center text-md-right">
                            <h2>Receipt</h2>
                            <p class="pb-3">#{{$obj->trx_number}}</p>
                            <ul class="px-0 list-unstyled">
                                <li>Amount</li>
                                <li class="lead text-bold-800">$ {{ number_format($obj->amount, 2, '.', ' ') }}</li>
                            </ul>
                        </div>
                    </div>
                    <!--/ Invoice Company Details -->
                    ...
                    <div id="invoice-customer-details" class="row pt-2">
                        <div class="col-sm-12 text-center text-md-left">
                            <p class="text-muted">Receipt To</p>
                        </div>
                        <div class="col-md-6 col-sm-12 text-center text-md-left">
                            <ul class="px-0 list-unstyled">
                        ...
                        <div class="col-md-6 col-sm-12 text-center text-md-right">
                            <p>
                                <span class="text-muted">Payment Date :</span> {{ \Carbon\Carbon::parse($obj->date)->format('d/m/Y') }}</p>
                            <p>
                                <span class="text-muted">Related to :</span> {{$obj->getEnrollment->enrollment_number}}</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="table-responsive col-sm-12">
                                <table class="table">
                                    ...
                                    <tbody>
                                    @foreach($obj->getEnrollment->getCourses as $course)
                                        <tr>
                            ...
                            <div class="col-md-5 col-sm-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Amount </td>
                                            <td class="text-right">$ {{ number_format($obj->amount, 2, '.', ' ') }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div id="invoice-footer">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12 text-center no-print">
                                <a class="btn btn-info btn-lg my-1" href="{{route('download-payment',['id'=>$obj->id])}}"><i class="la la-download"></i> Download Invoice</a>
                            </div>
                        </div>
                    </div>
                    <!--/ Invoice Footer -->
