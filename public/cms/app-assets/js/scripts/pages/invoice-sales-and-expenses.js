/*=========================================================================================
    File Name: invoice-sales-and-expenses-type.js
    Description: Invoice yearly sales and expenses-type bar chart.
    ----------------------------------------------------------------------------------------
...
// invoice-sales-and-expenses-type
// ------------------------------
...
$(window).on("load", function(){
    ...
    require(
        ...
        function (ec) {
            ...
            // Initialize chart
            // ------------------------------
            var myChart = ec.init(document.getElementById('sales-and-expenses-type'));
